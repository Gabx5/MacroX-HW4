...
```{r part load, echo=FALSE, include=FALSE}
rm(list=ls())
############# NEW DATA  #############
...
```{r part data, echo=FALSE, include=FALSE}
...
```{r part transform data, echo=FALSE, include=FALSE}
#------------------------------------------------------------------------------------
...
```{r part priors, echo=FALSE, include=FALSE}
#------------------------------------------------------------------------------------
# PRIORS
#------------------------------------------------------------------------------------
...
```{r plot 6 IRF chol, echo=FALSE, eval=FALSE}
...
```{r plot 7 IRF SR, echo=FALSE, eval=FALSE}
...
#1. Compute reduced form error terms using data and posterior distributions of parameters
# = (Data - model) where for model use posterior version of Kilian model (1) in reduced form
# You should get as many as we have samples from posterior. Take median of them.
...
#Theta_j should be #IRFchol_median[4,,j] for bigger j it might be needed to recompute it (e.g. change forecast period)
#Follow the steps of the picture sent in group
```
............... 
...
IRFchol_low.95 <- apply(IRFchol_store2, c(2,3,4), quantile, 0.02,na.rm=TRUE)
IRFchol_high.95 <- apply(IRFchol_store2, c(2,3,4), quantile, 0.98,na.rm=TRUE)
...
IRFsign_low.95 <- apply(IRFsign_store2, c(2,3,4), quantile, 0.02,na.rm=TRUE)
IRFsign_high.95 <- apply(IRFsign_store2, c(2,3,4), quantile, 0.98,na.rm=TRUE)
...
```{r part data 2, echo=FALSE, include=FALSE}
...
```{r part transform data 2, echo=FALSE, include=FALSE}
#------------------------------------------------------------------------------------
# useful function for lagging data matrices
mlag <- function(X,lag){
  p <- lag
...
```{r part priors 2, echo=FALSE, include=FALSE}
#------------------------------------------------------------------------------------
# PRIORS
#------------------------------------------------------------------------------------
A_prior <- matrix(0, k, M) 
