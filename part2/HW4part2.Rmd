...
nburn <- 500               # number of burned draws
...
We propose the following sign restrictions, where the 3x3 upper left submatrix is based on Kilian & Murphy (2012). It might be important to note here that the proposed columns are not linear combinations of each other, which would result in the model not being identified. 
