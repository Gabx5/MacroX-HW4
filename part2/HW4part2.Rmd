...
```{r Reestimation of Model, include= FALSE}
...
```{r figure 2 plot}
# Create plots for the Historical Evolution of the Structural Shocks, 1975–2007 
par(mfrow=c(3,1))
...
## Subquestion 2.3 - Reasonable Sign Restrictions
Sign restrictions:
```{r Reestimate Original Model}
#------------------------------------------------------------------------------------
# useful function for lagging data matrices
mlag <- function(X,lag){
  p <- lag
